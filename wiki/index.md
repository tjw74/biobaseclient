...
*Last updated: 2026-07-01T07:35:26Z*
...
- [Replay Demo Playback](projects/biobase/concepts/biobase-replay-demo-playback.md) — CS2 as render engine; v0.11.32 resolves the real Steam CS2 library, stages a generated replay cfg with quoted `playdemo`, and launches Steam+CS2 in one documented `-applaunch +exec` request; console injection remains retired
