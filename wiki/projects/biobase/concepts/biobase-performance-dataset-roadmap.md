...
## Release implementation — 2026-06-24

The Flutter Performance Review now uses `biobase-performance-v1`: every category carries source, evidence state, and confidence; unavailable categories are excluded instead of rendered as zero; biometric absence is explicit; and paired client sessions persist through authenticated SQLite-backed API history. See [[biobase-performance-contract]].
