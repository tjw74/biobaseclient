...
*Last updated: 2026-06-29T09:42:46Z*
...
- [Replay Demo Playback](projects/biobase/concepts/biobase-replay-demo-playback.md) — CS2 as render engine; v0.11.25 stages demos, writes replay cfg, launches with +exec/+playdemo, and injects exec/playdemo via Win32 SendInput if Netcon never opens
